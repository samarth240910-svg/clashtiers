...
export const recentResults: ResultEntry[] = [
  ...
  { id: "CT-10478", player: "mossagate", gamemode: "crystal", tier: "HT3", previousTier: "LT4", tester: "HollowGrade", region: "AS", feedback: "Handled explosions well, good spacing.", minutesAgo: 48 },
  ...
  { id: "CT-10473", player: "opalvex", gamemode: "mace", tier: "HT3", previousTier: "HT4", tester: "CobaltEval", region: "EU", feedback: "Good burst timing on wind-charge combos.", minutesAgo: 142 },
  { id: "CT-10472", player: "Emberquill", gamemode: "spearmace", tier: "HT3", tester: "AmberRank", region: "EU", feedback: "Good use of spear range to control distance.", tip: "Mix in more mace bursts up close.", minutesAgo: 165 },
];
